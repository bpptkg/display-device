  ...
  <div>
    ...
    <SidepanelTabs v-model="tabIndex" sidepanel-class="secondary-nav">
      <SidepanelTab
        ...
        :active="tabIndex === 0"
      >
        <WeatherKaliurangStats />
      </SidepanelTab>
    </SidepanelTabs>

    <WeatherKaliurangBotPanelStats />
  </div>
</template>
...
import rangeSelector, {
  maxCustomDuration,
} from '@/store/weather/kaliurang/rainfall/range-selector'
import {
  SET_PERIOD,
  SET_START_TIME,
  SET_END_TIME,
} from '@/store/base/mutations'
import { NAMESPACE as RAINFALL_NAMESPACE } from '@/store/weather/kaliurang/rainfall'
import { UPDATE_METEOROLOGY } from '@/store/weather/kaliurang/rainfall/actions'

import PressureChart from './PressureChart'
import RainfallChart from './RainfallChart'
import WeatherKaliurangStats from './WeatherKaliurangStats'
import WeatherKaliurangBotPanelStats from './WeatherKaliurangBotPanelStats'
