  ...
  <div>
    ...
    <SidepanelTabs v-model="tabIndex" sidepanel-class="secondary-nav">
      <SidepanelTab
        ...
        :active="tabIndex === 0"
      >
        <WeatherPasarbubar2Stats />
      </SidepanelTab>
    </SidepanelTabs>

    <WeatherPasarbubar2BotPanelStats />
  </div>
</template>
...
import rangeSelector, {
  maxCustomDuration,
} from '@/store/weather/pasarbubar2/rainfall/range-selector'
import {
  SET_PERIOD,
  SET_START_TIME,
  SET_END_TIME,
} from '@/store/base/mutations'
import { NAMESPACE as RAINFALL_NAMESPACE } from '@/store/weather/pasarbubar2/rainfall'
import { UPDATE_METEOROLOGY } from '@/store/weather/pasarbubar2/rainfall/actions'

import PressureChart from './PressureChart'
import RainfallChart from './RainfallChart'
import WeatherPasarbubar2Stats from './WeatherPasarbubar2Stats'
import WeatherPasarbubar2BotPanelStats from './WeatherPasarbubar2BotPanelStats'
