...
import rangeSelector, {
  maxCustomDuration,
} from '@/store/weather/jrakah/rainfall/range-selector'
import {
  SET_PERIOD,
  SET_START_TIME,
  SET_END_TIME,
} from '@/store/base/mutations'
import { NAMESPACE as RAINFALL_NAMESPACE } from '@/store/weather/jrakah/rainfall'
import { UPDATE_METEOROLOGY } from '@/store/weather/jrakah/rainfall/actions'

import PressureChart from './PressureChart'
import RainfallChart from './RainfallChart'
import WeatherJrakahStats from './WeatherJrakahStats'
import WeatherJrakahBotPanelStats from './WeatherJrakahBotPanelStats'

export default {
  name: 'WeatherJrakahView',
  components: {
    PressureChart,
    RainfallChart,
    RangeSelector,
