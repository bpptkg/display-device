...
import { getStatsInfo } from '@/components/echarts/chart-options/weather-pasarbubar/utils'

import { NAMESPACE } from '@/store/weather/pasarbubar/rainfall'
import fieldOptions from '@/store/weather/pasarbubar/rainfall/field-options'

export default {
  name: 'WeatherPasarbubarBotPanelStats',
  components: {
    StatsPanelPeriod,
    StatsPanelTable,
    BCard,
