...
import rangeSelector, {
  maxCustomDuration,
} from '@/store/weather/selo/rainfall/range-selector'
import {
  SET_PERIOD,
  SET_START_TIME,
  SET_END_TIME,
} from '@/store/base/mutations'
import { NAMESPACE as RAINFALL_NAMESPACE } from '@/store/weather/selo/rainfall'
import { UPDATE_METEOROLOGY } from '@/store/weather/selo/rainfall/actions'

import PressureChart from './PressureChart'
import RainfallChart from './RainfallChart'
import WeatherSeloStats from './WeatherSeloStats'
import WeatherSeloBotPanelStats from './WeatherSeloBotPanelStats'
