  ...
  <div>
    ...
    <SidepanelTabs v-model="tabIndex" sidepanel-class="secondary-nav">
      <SidepanelTab
        ...
        :active="tabIndex === 0"
      >
        <WeatherJurangJeroStats />
      </SidepanelTab>
    </SidepanelTabs>

    <WeatherJurangJeroBotPanelStats />
  </div>
</template>
...
import rangeSelector, {
  maxCustomDuration,
} from '@/store/weather/jurangjero/rainfall/range-selector'
import {
  SET_PERIOD,
  SET_START_TIME,
  SET_END_TIME,
} from '@/store/base/mutations'
import { NAMESPACE as RAINFALL_NAMESPACE } from '@/store/weather/jurangjero/rainfall'
import { UPDATE_METEOROLOGY } from '@/store/weather/jurangjero/rainfall/actions'

import PressureChart from './PressureChart'
import RainfallChart from './RainfallChart'
import WeatherJurangJeroStats from './WeatherJurangJeroStats'
import WeatherJurangJeroBotPanelStats from './WeatherJurangJeroBotPanelStats'

export default {
  name: 'WeatherJurangJeroView',
  components: {
    PressureChart,
    RainfallChart,
    RangeSelector,
