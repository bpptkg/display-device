  ...
  <div>
    ...
    <SidepanelTabs v-model="tabIndex" sidepanel-class="secondary-nav">
      <SidepanelTab
        ...
        :active="tabIndex === 0"
      >
        <WeatherKlatakanStats />
      </SidepanelTab>
    </SidepanelTabs>

    <WeatherKlatakanBotPanelStats />
  </div>
</template>
...
import rangeSelector, {
  maxCustomDuration,
} from '@/store/weather/klatakan/rainfall/range-selector'
import {
  SET_PERIOD,
  SET_START_TIME,
  SET_END_TIME,
} from '@/store/base/mutations'
import { NAMESPACE as RAINFALL_NAMESPACE } from '@/store/weather/klatakan/rainfall'
import { UPDATE_METEOROLOGY } from '@/store/weather/klatakan/rainfall/actions'

import PressureChart from './PressureChart'
import RainfallChart from './RainfallChart'
import WeatherKlatakanStats from './WeatherKlatakanStats'
import WeatherKlatakanBotPanelStats from './WeatherKlatakanBotPanelStats'

export default {
  name: 'WeatherKlatakanView',
  components: {
    PressureChart,
    RainfallChart,
    RangeSelector,
