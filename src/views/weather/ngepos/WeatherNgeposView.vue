...
import rangeSelector, {
  maxCustomDuration,
} from '@/store/weather/ngepos/rainfall/range-selector'
import {
  SET_PERIOD,
  SET_START_TIME,
  SET_END_TIME,
} from '@/store/base/mutations'
import { NAMESPACE as RAINFALL_NAMESPACE } from '@/store/weather/ngepos/rainfall'
import { UPDATE_METEOROLOGY } from '@/store/weather/ngepos/rainfall/actions'

import PressureChart from './PressureChart'
import RainfallChart from './RainfallChart'
import WeatherNgeposStats from './WeatherNgeposStats'
import WeatherNgeposBotPanelStats from './WeatherNgeposBotPanelStats'
